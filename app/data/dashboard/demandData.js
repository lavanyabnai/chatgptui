...
import { pieChartData } from '~/kendo/charts/pie/pieChartData'
...
import {shipmentsData_m,
  ...
  invoiceCategories_m,
  invoiceSeries_m} from '~/kendo/rawData/dashboard/demandDashboard'
...
export const kpiService_m = [
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 90,
    container: <WrapperMultiBarChart category={cancelCategories_m} series={cancelSeries_m} />,
    status: "Below Target",
    Explore:<WrapperGrid rowData={carData}/>,
    Analyze:'/demo/dashboard/analysis/demandAnalysis'
  },
  {
    ...
    Trend: 'down',
    TargetAch: 90,
    container: <WrapperMultiLineChart category={mapeCategories_m} series={mapeSeries_m}/>,
    status: "On Track",
    Explore:<WrapperGrid rowData={carData}/>,
    Analyze:"/demo/dashboard/analysis/demandAnalysis"
  },
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 90,
    container: <WrapperMultiColumnChart category={lateCategories_m} series={lateSeries_m} />,
    status: "On Track",
    Explore:<WrapperGrid rowData={carData}/>,
  ...
  },
  {
    ...
    Trend: 'down',
    TargetAch: 90,
    container: <WrapperMultiAreaChart category={ontimeCategories_m} series={ontimeSeries_m}/>,
    status: "Below Target",
    Explore:<WrapperGrid rowData={carData}/>,
    Analyze:"/demo/dashboard/analysis/demandAnalysis"
  },
  {
    ...
    Trend: 'up',
    TargetAch: 77,
    container: <WrapperMultiBarChart category={perfectCategories_m} series={perfectFirstSeries_m} />,
    status: "On Track",
    Explore:<WrapperGrid rowData={carData}/>,
    Analyze:"/demo/dashboard/analysis/orderAnalysis"
  },
  {
    ...
    Trend: 'up',
    TargetAch: 95,
    container: <WrapperMultiLineChart category={invoiceCategories_m} series={invoiceSeries_m}/>,
    status: "Above Target",
    Explore:<WrapperGrid rowData={carData}/>,
    Analyze:"/demo/dashboard/analysis/orderAnalysis"
  },
