...
import {revenueSeries_m,
  opCategories_m,
  opSeries_m,
  ebitdaCategories_m,
  ebitdaSeries_m,
  costCategories_m,
  costSeries_m,payrollSeries_m,
  ebitdaMarginCategories_m,
  ebitdaMarginSeries_m,
  netSeries_m,
  grossCategories_m,
  grossSeries_m} from '~/kendo/rawData/dashboard/profitDashboard'
...
export const kpiService_m = [
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 90,
    container: <WrapperMultiColumnChart category={opCategories_m} series={opSeries_m}/>,
    status: "Below Target",
    Explore:<WrapperGrid rowData={carData}/>,
    Analyze: '/demo/dashboard/analysis/perfAnalysis'
  },
  {
    Name: 'EBITDA',
    Value: '$14.23M',
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 95,
    container: <WrapperMultiColumnChart category={grossCategories_m} series={grossSeries_m}/>,
    status: "Above Target",
    Explore:<WrapperGrid rowData={carData}/>,
    Analyze: '/demo/dashboard/analysis/perfAnalysis'
  },
...
export const kpiCost_q = [
  ...
  },
  {
    ...
    Trend: 'down',
    TargetAch: 90,
    container: <WrapperMultiBarChart category={ebitdaMarginCategories_m} series={ebitdaMarginSeries_m}/>,
    status: "Below Target",
    Explore:<WrapperGrid rowData={carData}/>,
    Analyze:"demandAnalysis"
  },
