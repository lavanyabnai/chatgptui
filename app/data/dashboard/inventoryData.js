...
export const kpiService_m = [
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 80,
    container: <WrapperMultiBarChart category={avgInventoryCategories_m} series={avgInventorySeries_m} />,
    status: "Below Target",
    Analyze: '/demo/dashboard/analysis/inventoryAnalysis'
  },
  {
  ...
  },
  {
    ...
    Trend: 'down',
    TargetAch: 10,
    container: <WrapperMultiLineChart category={unitCategories_m} series={unitSeries_m}/>,
    status: "Below Target",
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 90,
    container: <WrapperMultiAreaChart category={resourceCategories_m} series={resourceSeries_m} />,
    status: "Above Target",
    Analyze: '/demo/dashboard/analysis/invcostAnalysis'
  },
  {
    ...
    Trend: 'down',
    TargetAch: 90,
    container: <WrapperMultiLineChart category={overheadCategories_m} series={overheadSeries_m} />,
    status: "Below Target",
    Analyze: '/demo/dashboard/analysis/invcostAnalysis'
  },
  {
    ...
    Trend: 'up',
    TargetAch: 77,
    container: <WrapperMultiBarChart category={materialCategories_m} series={materialSeries_m} />,
    status: "Below Target",
    Analyze: '/demo/dashboard/analysis/invcostAnalysis'
  },
  {
    ...
    Trend: 'up',
    TargetAch: 95,
    container: <WrapperMultiBarChart category={turnsCategories_m} series={turnsSeries_m} />,
    status: "Above Target",
    Analyze: '/demo/dashboard/analysis/inventoryAnalysis'
  },
]
