...
import {salesCategory_m,salesData_m,forecastCategories_m,forecastSeries_m,
ontimeCategories_m,
ontimeSeries_m,backlogData_m,
costCategories_m,
costSeries_m,
inventoryCategories_m,
inventorySeries_m, marketingCategories_m,
marketingSeries_m,
logisticsCategories_m,
logisticsSeries_m} from '~/kendo/rawData/dashboard/overviewDashboard'
...
export const kpiService_m = [
  {
    ...
    Trend: 'up',
    TargetAch: 75,
    container: <WrapperMultiStackColChart category={salesCategory_m} series={salesData_m}/>,
    status: "Above Target",
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 90,
    container: <WrapperMultiColumnChart category={forecastCategories_m} series={forecastSeries_m} />,
    status: "Below Target",
    Explore: <WrapperGrid rowData={carData}/>,
  ...
  },
  {
    ...
    Trend: 'down',
    TargetAch: 50,
    container: <WrapperMultiAreaChart category={inventoryCategories_m} series={inventorySeries_m}/>,
    status: "Below Target",
    Explore: <WrapperGrid rowData={carData}/>,
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 80,
    container: <WrapperMultiBarChart category={marketingCategories_m} series={marketingSeries_m} />,
    status: "On Track",
    Explore: <WrapperGrid rowData={carData}/>,
  ...
  },
  {
    ...
    Trend: 'up',
    TargetAch: 95,
    container: <WrapperMultiLineChart category={logisticsCategories_m} series={logisticsSeries_m}/>,
    status: "Above Target",
    Explore: <WrapperGrid rowData={carData}/>,
    Analyze: '/demo/dashboard/analysis/inventoryAnalysis'
  }
