...
import {
  ...
  kpiService_y,
  kpiCost_y,
} from "~/data/analysis/proEfficencyData";
...
const navigation = [
  ...
  { name: "Procurement Efficinecy", href: "/demo/dashboard/analysis/proeffAnalysis", current: true },
...
const stats = [
  { name: "PR to PO Cycle Time", stat: "30.0" },
  { name: "PO Open Cycle Time", stat: "20.4" },
  { name: "PO Closed Cycle Time", stat: "24.2" },
  { name: "Amendments", stat: "100" },
];
...
export default function ProEffieciencyAnalysisRoute() {
            ...
            {({ open }) => (
              <>
                <div className="w-full px-2 py-2 sm:px-2 lg:px-2">
                  <div className="justify- flex h-12 items-center">
