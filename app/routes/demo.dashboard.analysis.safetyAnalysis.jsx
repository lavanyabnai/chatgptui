...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/safetyData";
...
const stats = [
  { name: "Cost per Unit", stat: "$1.5K" },
  { name: "Material Cost", stat: "$7M" },
  { name: "Labour Cost", stat: "$1.35M" },
  { name: "Equipment Cost", stat: "$451.2K" },
];
...
export default function SafteyAnalysisRoute() {
