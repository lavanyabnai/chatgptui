...
export default function Demo({ aiMessage }) {
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-7xl flex-grow overflow-auto">
        <div className="h-15 my-2 flex self-end rounded-lg border p-4 text-gray-200">
        ...
        <div className="my-2 flex self-end rounded-lg border bg-blue-500/50 p-4 text-gray-200">
          <div className="mr-2 flex flex-shrink-0 flex-col items-start">
