...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/quoteData";
...
const navigation = [
  { name: "Pipeline Analysis", href: "/demo/dashboard/analysis/pipelineAnalysis", current: false },
  { name: "Won Analysis", href: "/demo/dashboard/analysis/wonAnalysis", current: false },
  { name: "Quote Analysis ", href: "/demo/dashboard/analysis/quoteAnalysis", current: true },
...
const stats = [
  { name: "# of Open Opportunities", stat: "760" },
  { name: "# of Quotes", stat: "225" },
  { name: "Open Pipeline Revenue", stat: "$48.21M" },
  { name: "Total Contract Value", stat: "$55.28M" },
];
...
export default function QuoteAnalysisRoute() {
