...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/offContractData";
...
const navigation = [
  ...
  { name: "Off-Contract Spend", href: "/demo/dashboard/analysis/offContractAnalysis", current: true },
  { name: "Expense Analysis", href: "/demo/dashboard/analysis/expenseAnalysis", current: false },
  { name: "Payable Analysis", href: "/demo/dashboard/analysis/apAnalysis", current: false },
...
export default function OffcontractAnalysisRoute() {
  ...
  return (
    <>
      ...
      <ul
        ...
        {/* "mx-4 my-4 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 " */}
