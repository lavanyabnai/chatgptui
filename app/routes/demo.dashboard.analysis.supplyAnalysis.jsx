...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/supplyData";
...
const navigation = [
  { name: "Supply Analysis", href: "/demo/dashboard/analysis/supplyAnalysis", current: true },
...
const stats = [
  { name: "OnTime Delivery", stat: "49" },
  { name: "Early Delivery %", stat: "30" },
  { name: "Late Delivery", stat: "21" },
  { name: "Receipt Lines Returned %", stat: "21" },
];
