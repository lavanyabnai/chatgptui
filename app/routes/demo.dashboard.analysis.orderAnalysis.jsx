import {
  ...
  kpiService_m,
} from "~/data/analysis/scmOverviewData";
// import { reviewTabs,meetingTabs,kpiService_m,kpiCost_m,kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/scmOverviewData";
...
import { ChevronDownIcon, ChevronDoubleRightIcon, } from "@heroicons/react/20/solid";

const navigation = [
  {
    name: "Order to Cash",
    href: "/demo/dashboard/analysis/demandAnalysis",
    current: false,
  },
  {
    name: "Order Analysis",
    href: "/demo/dashboard/analysis/orderAnalysis",
    current: true,
  },
...
const stats = [
  { name: "Bookings", stat: "$1.88B" },
  { name: "Open Orders", stat: "$719.5M" },
