...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/mfgperData";
...
const navigation = [
  ...
  { name: "Order Analysis", href: "#", current: true },
  { name: "Fulfillment Analysis", href: "#", current: false },
  { name: "Order to Cash Analysis ", href: "#", current: false },
];
...
const stats = [
  { name: "Production Volume", stat: "72M" },
  { name: "Downtime", stat: "4.4%" },
  { name: "Overall Operations Effectiveness(OOE)", stat: "73%" },
  { name: "Overall Equipment Effectiveness(OOE)", stat: "$451.2K" },
];
...
export default function MfgperAnalysisRoute() {
