...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/opexpenseData";
...
const navigation = [
  { name: "Operating Expense Analysis", href: "/demo/dashboard/analysis/opexpenseAnalysis", current: true },
  { name: "Profit Analysis", href: "/demo/dashboard/analysis/profitAnalysis", current: false },
...
export default function OpExpenseAnalysisRoute() {
