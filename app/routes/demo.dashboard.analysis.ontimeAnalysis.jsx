...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/ontimeData";
...
const stats = [
  { name: "Right Frist Time", stat: "80%" },
  { name: "First Pass Yield", stat: "92%" },
  { name: "Rate of Return", stat: "5%" },
  { name: "Rework", stat: "15%" },
];
...
export default function OntimeAnalysisRoute() {
  ...
  return (
    <>
      ...
      <ul
        role="list"
        className="mx-4 my-4 grid grid-cols-1 gap-6 lg:grid-cols-1" >
