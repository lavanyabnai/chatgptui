...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/spendData";
...
const navigation = [
  ...
  { name: "Spend Analysis", href: "/demo/dashboard/analysis/spendAnalysis", current: true },
