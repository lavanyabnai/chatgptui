...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/savingsData";
...
const navigation = [
  { name: "Supply Analysis", href: "/demo/dashboard/analysis/supplyAnalysis", current: false },
  { name: "Savings Analysis", href: "/demo/dashboard/analysis/savingsAnalysis", current: true },
  { name: "Procurement Efficinecy", href: "/demo/dashboard/analysis/proeffAnalysis", current: false },
  { name: "Spend Analysis", href: "/demo/dashboard/analysis/spendAnalysis", current: false },
  { name: "Procure to Pay", href: "/demo/dashboard/analysis/procureAnalysis", current: false },
];
...
const stats = [
  { name: "Discounts", stat: "$2.6M" },
  { name: "Savings Potential Amount", stat: "$2.9M" },
  { name: "% Savings Potential", stat: "15%" },
  { name: "Off-Contract", stat: "$60.7M" },
];
...
export default function SavingsAnalysisRoute() {
