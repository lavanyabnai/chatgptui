import { kpiService_m } from "~/data/analysis/inventorycostData";
...
const navigation = [
  {
    ...
    href: "/demo/dashboard/analysis/inventoryAnalysis",
    current: false,
  },
  {
    name: "Inventory Cost Analysis",
    href: "/demo/dashboard/analysis/invcostAnalysis",
    current: true,
  },
];
...
export default function InventoryCostAnalysisRoute() {
