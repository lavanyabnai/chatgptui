...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/procureData";
...
const navigation = [
  ...
  { name: "Savings Analysis", href: "/demo/dashboard/analysis/savingsAnalysis", current: false },
  ...
  { name: "Procure to Pay", href: "/demo/dashboard/analysis/procureAnalysis", current: true },
];
...
const stats = [
  { name: "Agreement Amount", stat: "$10M" },
  { name: "PO Amount", stat: "$23.4M" },
  { name: "Received Amount", stat: "$15.8M" },
  { name: "Invoiced Amount %", stat: "$8.5" },
];
...
export default function ProcureAnalysisRoute() {
