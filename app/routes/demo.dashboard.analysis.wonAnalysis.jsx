...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/wonData";
...
const navigation = [
  ...
  { name: "Won Analysis", href: "/demo/dashboard/analysis/wonAnalysis", current: true },
...
const stats = [
  { name: "Won & Lost Revenue by Date", stat: "$4.23M" },
  { name: "Lost Revenue", stat: "$4.36M" },
  { name: "No Sale Revenue", stat: "$814.77K" },
  { name: "Revenue Won Rate", stat: "82.87" },
];
...
export default function WonAnalysisRoute() {
