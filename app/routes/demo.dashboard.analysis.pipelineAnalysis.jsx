...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/pipelineData";
...
const navigation = [
  { name: "Pipeline Analysis", href: "/demo/dashboard/analysis/pipelineAnalysis", current: true },
  { name: "Won Analysis", href: "/demo/dashboard/analysis/wonAnalysis", current: false },
  { name: "Quote Analysis ", href: "/demo/dashboard/analysis/quoteAnalysis", current: false },
  { name: "Win Analysis ", href: "/demo/dashboard/analysis/winAnalysis", current: false },
];
...
const stats = [
  { name: "Open Opportunity", stat: "$1.86B" },
  { name: "Quoted Opportunity Revenue", stat: "$2.70M" },
  { name: "# of Open Opportunity", stat: "5,020" },
  { name: "Conversion Rate", stat: "43.45" },
];
...
export default function PipelineAnalysisRoute() {
