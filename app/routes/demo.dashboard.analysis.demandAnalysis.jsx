import { kpiService_m } from "~/data/analysis/demandData";
...
const navigation = [
  { name: "Order to Cash", href: "/demo/dashboard/analysis/demandAnalysis", current: true },
  { name: "Order Analysis", href: "/demo/dashboard/analysis/orderAnalysis", current: false },
];
const sortOptions = [
...
const stats = [
  ...
  { name: "Invoiced", stat: "$1.1B" },
  { name: "Revenue", stat: "$1.2B" },
...
export default function DemandAnalysisRoute() {
