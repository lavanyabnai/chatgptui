...
import { reviewTabs,meetingTabs,kpiService_m, kpiCost_m, kpiService_q,kpiCost_q ,kpiService_y, kpiCost_y,} from "~/data/analysis/payableData";
...
const navigation = [
  { name: "Spend Analysis", href: "/demo/dashboard/analysis/spendAnalysis", current: false },
  { name: "Off-Contract Spend", href: "/demo/dashboard/analysis/offContractAnalysis", current: false },
  { name: "Expense Analysis", href: "/demo/dashboard/analysis/expenseAnalysis", current: false },
  { name: "Payable Analysis", href: "/demo/dashboard/analysis/apAnalysis", current: true },
  { name: "Category Analysis", href: "/demo/dashboard/analysis/categoryAnalysis", current: false },
];
...
const stats = [
  { name: "Overdue Amount", stat: "$4.2M" },
  { name: "Overdue %", stat: "100%" },
  { name: "# of Overdue Invoice", stat: "27" },
  { name: "Days Payable Outstanding", stat: "28.11" },
];
...
export default function PayableAnalysisRoute() {
