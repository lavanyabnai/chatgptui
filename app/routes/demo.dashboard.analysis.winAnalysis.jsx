import { kpiService_m } from "~/data/analysis/winData";
...
const navigation = [
  ...
  { name: "Win Analysis ", href: "/demo/dashboard/analysis/winAnalysis", current: true },
];
...
export default function WinAnalysisRoute() {
